...
GUNCARD="config_dr.gun"


WORKDIR=/eos/experiment/fcc/ee/datasets/DC_tracking/Pythia/scratch/${SAMPLE}_dr/${NUM}/
echo $WORKDIR
FULLOUTDIR=${OUTDIR}/${SAMPLE}_dr
