...
parser.add_argument("--outputFile", default="out_tracker_noClustering.root", help="OutputFile")
...
from Configurables import GGTF_tracking_noClustering

GGTF = GGTF_tracking_noClustering(
