...
WORKDIR=/eos/experiment/fcc/ee/datasets/DC_tracking/Pythia_evaluation/scratch/${SAMPLE}/${NUM}/
echo $WORKDIR
...
#source /cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-02-22/x86_64-almalinux9-gcc11.3.1-opt/key4hep-stack/2024-02-22-hdlxud/setup.sh
# if [[ "${SAMPLE}" == "Zcard" ]]
# then
