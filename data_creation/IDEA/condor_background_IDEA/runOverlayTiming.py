...
overlay.SimTrackerHits = ["CDCHHits", "VTXDCollection", "VTXIBCollection", "VTXOBCollection"]
overlay.SimCalorimeterHits = []
overlay.OutputSimTrackerHits = ["NewCDCHHits", "NewVTXDCollection","NewVTXIBCollection", "NewVTXOBCollection"]
...
overlay.TimeWindows = {"MCParticles": [0, 1000], "CDCHHits": [0, 400],"VTXDCollection": [0, 19], "VTXIBCollection": [0, 19], "VTXOBCollection": [0, 19] }
overlay.Delta_t = 20
