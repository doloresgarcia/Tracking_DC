...
NUM=${1} #random seed
SAMPLE="Zcard_tau_CLD" #main card
GUNCARD="config.gun"


WORKDIR=/eos/experiment/fcc/ee/datasets/DC_tracking/Pythia/scratch/${SAMPLE}_1024_v1/${NUM}/
SAMPLE="Zcard_tau_CLD" #main card
echo $WORKDIR
FULLOUTDIR=${OUTDIR}/${SAMPLE}_1024_v1/
...
python process_tree_global.py output_IDEA_DIGI.root reco_${SAMPLE}_${NUM}_mc2.root True
